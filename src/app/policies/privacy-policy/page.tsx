...
const PrivacyPolicy = () => {
  ...
  return (
    <PolicyContainer>
      {" "}
      {/* Title */}
      <h1 className="sm:text-3xl text-2xl font-bold mb-4">Privacy Policy</h1>
      <p className={`text-sm mb-6`}>Last updated: August 18, 2025</p>
      ...
      {/* Section 1 */}
      <h2 className="sm:text-2xl text-xl font-semibold mt-8 mb-4">
        Interpretation and Definitions
      </h2>
      <h3 className="sm:text-xl text-lg font-semibold mt-6 mb-2">
        Interpretation
      </h3>
      <p className="mb-4 leading-relaxed">
      ...
      <ul className="pl-0 space-y-3">
        ...
        <li className="before:content-['-'] before:mr-2 before:inline-block">
          <strong>Website</strong> refers to The Corporate Girlie Arts,
          accessible from{" "}
          <Link
      ...
      {/* Section 2 */}
      <h2 className="sm:text-2xl text-xl font-semibold mt-10 mb-6">
        Collecting and Using Your Personal Data
      </h2>
      {/* Subsection */}
      <h3 className="sm:text-xl text-lg font-semibold mt-6 mb-4">
      ...
      <ul className={`list-none space-y-2`}>
        <li className="before:content-['-'] before:mr-2">Email address</li>
        <li className="before:content-['-'] before:mr-2">
          First name and last name
        </li>
        <li className="before:content-['-'] before:mr-2">Phone number</li>
        <li className="before:content-['-'] before:mr-2">
          Address, State, Province, ZIP/Postal code, City
        </li>
      </ul>
      {/* Usage Data */}
      <h4 className="text-lg font-medium mt-8 mb-3">Usage Data</h4>
      ...
      <ul className="list-none space-y-6">
        <li className="flex before:content-['-'] before:mr-2">
          <div>
            <p>
      ...
      {/* Retention Section */}
      <h3 className="sm:text-xl text-lg font-semibold mt-10 mb-4">
      ...
      <p className="mb-4 leading-relaxed">
        ...
        Company&apos;s where the processing are located. It means that this
      ...
      {/* Disclosure */}
      <h3 className="sm:text-2xl text-xl font-semibold mt-10 mb-4">
        Disclosure of Your Personal Data
      </h3>
      <h4 className="sm:text-xl text-lg font-semibold mt-6 mb-2">
      ...
      {/* Children */}
      <h2 className="sm:text-2xl text-xl font-bold sm:mt-10 mt-6 mb-4">
        Children&apos;s Privacy
      </h2>
      <p className="mb-2">
      ...
      {/* Contact */}
      <h2 className="sm:text-2xl text-xl font-bold sm:mt-10 mt-6 mb-4">Contact Us</h2>
