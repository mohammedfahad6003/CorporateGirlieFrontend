...
const TermsAndConditions = () => {
  ...
  return (
    <PolicyContainer>
      ...
      <p className="mb-4">Last updated: August 19, 2025</p>
      <p className="mb-4">
      ...
      <h3 className={`text-lg font-medium mt-4 mb-2 ${textColor}`}>
        Interpretation
      </h3>
      <p className="mb-4">
      ...
      <ul className="list-none mb-4 space-y-2">
        ...
        <li className="before:content-['-'] before:mr-2">
          ...
          this Agreement) refers to The Corporate Girlie Arts.
        </li>
        <li className="before:content-['-'] before:mr-2">
      ...
      <p className="mb-2">
        ...
        agree to the new terms, in whole or in part, please stop A using the
