...
export default function CookieConsent() {
  ...
  return (
    <>
      {/* Full banner */}
      {visible && (
        <div className="fixed bottom-5 left-1/2 -translate-x-1/2 w-[90%] sm:w-[70%] max-w-xl sm:max-w-3xl bg-white/95 backdrop-blur-lg text-gray-800 px-4 sm:px-6 py-3 sm:py-4 shadow-2xl rounded-2xl z-[35] border border-pink-200">
      ...
      {!visible && consent && (
        <button
          ...
          className="cookie-btn fixed bottom-5 right-5 bg-gradient-to-r from-pink-400 to-yellow-400 text-white px-4 sm:px-5 py-2.5 sm:py-3 rounded-full shadow-lg text-xs sm:text-sm hover:opacity-90 transition z-[35] flex items-center gap-2 cursor-pointer"
        >
